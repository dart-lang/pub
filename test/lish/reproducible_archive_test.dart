...
void main() {
  test('creates byte-for-byte identical archives regardless of file mtime or '
    ...
    while (await tarReader.moveNext()) {
      ...
      expect(entry.header.modified, equals(DateTime.utc(1970)));
  ...
  test(
    'respects SOURCE_DATE_EPOCH environment variable for archive entries',
    () async {
      await d.validPackage().create();
      await d.dir(appPath, [
      ...
      await runPub(
        ...
        environment: {'SOURCE_DATE_EPOCH': '$customEpochSeconds'},
      );
