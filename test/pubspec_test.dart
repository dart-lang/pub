...
''', sources);
  ...
  group('typo warnings', () {
    test('normal pubspec has no warnings', () {
      ...
      expect(pubspec.typoWarnings, equals({}));
    });

    test('typo in dependencies key is detected', () {
      final pubspec = Pubspec.fromMap({
        'name': 'myapp',
        'depenedncies': {},
      }, null);

      expect(pubspec.typoWarnings, equals({'depenedncies': 'dependencies'}));
    });

    test('typo in name key is detected', () {
      final pubspec = Pubspec.fromMap({
        'naem': 'myapp',
      }, null);

      expect(pubspec.typoWarnings, equals({'naem': 'name'}));
    });

    test('typo in dependency_overrides key is detected', () {
      final pubspec = Pubspec.fromMap({
        'name': 'myapp',
        'dependency_override': {},
      }, null);

      expect(pubspec.typoWarnings,
          equals({'dependency_override': 'dependency_overrides'}));
    });
  });
}
