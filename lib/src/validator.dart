...
abstract class Validator {
  ...
  void validateSdkConstraint(Version firstSdkVersion, String message) {
    ...
    if (entrypoint.root.pubspec.originalDartSdkConstraint.intersect(VersionRange(max: firstSdkVersion))
        .isEmpty) {
      return;
    }
    ...
    var newSdkConstraint = entrypoint.root.pubspec.originalDartSdkConstraint.intersect(allowedSdks);
