...
Generated by pub on ${DateTime.now()}.''';
  ...
  /// Throws a [DataException] if the content-hash of some hosted package locked in this lock file differs from the
  /// one in the cache.
  void enforceContentHashes(SystemCache cache) {
