    ...
    for (final id in packages.values) {
      ...
      if (description is ResolvedHostedDescription) {
        ...
        if (cachedHash == null) {
          ...
          description = description.withSha256(cachedHash);
        } else {
...
* A corruption of your cache (try running `$topLevelProgram pub cache clean`).
    ...
    for (final id in packages.values) {
      ...
      if (description is ResolvedHostedDescription) {
        ...
        if (hash == null) {
          ...
          assert(bytesEquals(hash, description.sha256),
